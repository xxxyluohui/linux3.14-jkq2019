...
#define TSP_MAXX				4095
#define TSP_MAXY				4095

#ifdef CONFIG_FB_TFT320x240
#define TSP_LCDX				(320 * 4)
#define TSP_LCDY				(240 * 4)
#endif

#ifdef CONFIG_FB_TFT480x272
#define TSP_LCDX				(480 * 4)
#define TSP_LCDY				(272 * 4)
#endif

#ifdef CONFIG_FB_TFT800x480
#define TSP_LCDX				(800 * 4)
#define TSP_LCDY				(480 * 4)
#endif

#ifdef CONFIG_FB_TFT800x600
#define TSP_LCDX				(800 * 4)
#define TSP_LCDY				(600 * 4)
#endif
/*lh add end*/
struct imx6ul_tsc {
	struct device *dev;
...
touch_event:
		if (xnur == 0) {
            if(0)
            {
    			x=(px[0]+px[1]+px[2]+px[3]+px[4])/5;
    			y=(py[0]+py[1]+py[2]+py[3]+py[4])/5;
                
               // printk(KERN_INFO"px=%d ",px[0]);
               // printk(KERN_INFO"px=%d ",px[1]);
               // printk(KERN_INFO"px=%d ",px[2]);
               // printk(KERN_INFO"px=%d ",px[3]);
               // printk(KERN_INFO"px=%d\n",px[4]);
               // printk(KERN_INFO"py=%d ",py[0]);
               // printk(KERN_INFO"px=%d ",py[1]);
               // printk(KERN_INFO"px=%d ",py[2]);
               // printk(KERN_INFO"px=%d ",py[3]);
               // printk(KERN_INFO"py=%d\n",py[4]);
               }
