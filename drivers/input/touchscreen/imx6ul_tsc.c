...
#define ADC_LONG_SAMPLE_MODE	(0x1 << 4)
#define ADC_HARDWARE_TRIGGER	(0x1 << 13)
#define ADC_AVGS_8	            (0x1 << 14) //1:8次平均数 
#define ADC_AVGS_16	            (0x2 << 14) //2:16次平均数 
#define ADC_AVGS_32	            (0x3 << 14) //3:32次平均数 
...
#define ADC_TIMEOUT		msecs_to_jiffies(200)
...
static void imx6ul_adc_init(struct imx6ul_tsc *tsc)
{
	...
	adc_cfg |= ADC_CLK_DIV_8 | ADC_LONG_SAMPLE_MODE;
	adc_cfg &= ~ADC_HARDWARE_TRIGGER;
    adc_cfg |=ADC_AVGS_32; //硬件平均数32
